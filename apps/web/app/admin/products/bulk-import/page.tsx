 ...
 * ──────────────────────────────────────────────────────────────── */
const COLUMNS = [
  { key: "sku", required: false, sample: "PROD-001", descBn: "স্টক কিপিং ইউনিট — সার্ভার অটো-জেনারেট করবে (যা-ই লিখুন, ইগনোর হবে)", descEn: "Stock keeping unit — server auto-generates (whatever you write here is ignored)" },
    ...
    <div className="space-y-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-1 text-xs text-ink-600">
          ...
          <p>
            • {t(
              "SKU সার্ভার নিজে অটো-জেনারেট করবে (XM-000001, XM-000002, …)। CSV-তে কী লেখা আছে তা ইগনোর হবে।",
              "SKU is auto-generated by the server (XM-000001, XM-000002, …). Whatever is in the CSV column is ignored.",
            )}
          </p>
          <p>
            • {t(
