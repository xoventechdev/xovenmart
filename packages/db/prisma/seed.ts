...
<p>জোভেনমার্ট আপনার ব্যক্তিগত তথ্যের গোপনীয়তাকে সর্বোচ্চ গুরুত্ব দেয়। এই নীতি বর্ণনা করে আমরা কী তথ্য সংগ্রহ করি, কীভাবে ব্যবহার করি এবং কীভাবে সুরক্ষিত রাখি।</p>
<h3>সংগৃহীত তথ্য</h3>
...
<p>জোভেনমার্ট ওয়েবসাইট ও সেবা ব্যবহার করে আপনি নিম্নলিখিত শর্তাবলীতে সম্মত হচ্ছেন।</p>
...
<p>Return/refund requests must be made within 24 hours of delivery.</p>`,
    ...
    {
      slug: "about",
      titleBn: "জোভেনমার্ট সম্পর্কে",
      titleEn: "About XovenMart",
      contentBn: `<h2>আমাদের সম্পর্কে</h2>
<p>জোভেনমার্ট মুদাফরগঞ্জ, লাকসাম, কুমিল্লা অঞ্চলের একটি একক-বিক্রেতা অনলাইন শপিং প্ল্যাটফর্ম। আমরা সরাসরি স্থানীয় সরবরাহকারীদের কাছ থেকে পণ্য সংগ্রহ করে গ্রাহকদের দোরগোড়ায় পৌঁছে দিই।</p>
<h3>আমাদের লক্ষ্য</h3>
...
<p>We deliver across Mudaforgonj, Laksam Sadar, and selected areas of Cumilla city.</p>`,
  ...
  const settings: Array<{ key: string; value: Prisma.InputJsonValue }> = [
    ...
    { key: "store.nameBn", value: "জোভেনমার্ট" },
